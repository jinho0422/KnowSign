...
class MenutoDetails extends Component {
  constructor(props) {
    ...
    this.state = {
      ...
      favorite: false,
      sId: null,
      kor: false//this.props.route.params.data.kor, //true :kor
    }
  ...
  UpdateLang() {
    ...
    this.props.navigation.navigate('Restaurant Imformation', { menu: this.props.route.params.menu, data: this.state })
  }
